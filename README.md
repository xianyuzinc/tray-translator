...
- Floating popup: draggable, always on top, and designed for quick reading.
...
Screenshots are not included yet. The app currently focuses on the MVP workflow and a lightweight desktop footprint.
